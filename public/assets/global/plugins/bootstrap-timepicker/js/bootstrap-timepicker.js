...
(function($, window, document, undefined) {
  ...
  Timepicker.prototype = {
    ...
    getTemplate: function() {
      ...
      case 'modal':
        template = '<div class="bootstrap-timepicker-partials modal hide fade in" data-backdrop="'+ (this.modalBackdrop ? 'true' : 'false') +'">'+
        ...
        break;
      case 'dropdown':
        template = '<div class="bootstrap-timepicker-partials dropdown-menu">'+ templateContent +'</div>';
        break;
      }
    ...
    place : function() {
      ...
      // auto y orientation is best-situation: top or bottom, no fudging, decision based on which shows more of the partials
    ...
    showWidget: function() {
      ...
      // partials shouldn't be empty on open
      if (this.hour === '') {
        if (this.defaultTime) {
          this.setDefaultTime(this.defaultTime);
        } else {
