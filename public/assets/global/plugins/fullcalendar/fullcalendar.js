...
function Calendar(element, instanceOptions) {
	...
	function destroy() {
		...
		header.destroy();
		content.remove();
		element.removeClass('fc fc-ltr fc-rtl fc-unthemed ui-partials');
...
View.prototype = {
	...
	init: function() {
		...
		this.widgetHeaderClass = tm + '-partials-header';
		this.widgetContentClass = tm + '-partials-content';
