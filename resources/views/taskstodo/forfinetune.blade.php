...
{{--
                   <li>{{ $value->Title }}</li>
--}}
               <h4><a href="{{ URL::to('catagories/' . $value->id) }}">{{ $value->Title }}{{--<a class="btn btn-small btn-info" href="{{ URL::to('catagories/' . $value->id . '/edit') }}">Edit</a>
...
{{--
                                   <a class="btn btn-small btn-info" href="{{ URL::to('catagories/' . $value->id . '/edit') }}">Edit</a>
--}}
{{--                                    {!! Form::open(array('method'=> 'DELETE', 'route' => array('catagories.destroy', $value->id))) !!}
