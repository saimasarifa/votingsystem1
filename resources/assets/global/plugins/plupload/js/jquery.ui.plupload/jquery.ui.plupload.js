...
To use the partials you must include _jQuery_ and _jQuery UI_ bundle (including `ui.core`, `ui.partials`, `ui.button`,
`ui.progressbar` and `ui.sortable`).

In general the partials is designed the way that you do not usually need to do anything to it after you instantiate it.
But! You still can intervenue, to some extent, in case you need to. Although, due to the fact that partials is based on
_jQuery UI_ partials factory, there are some specifics. See examples below for more details.
...
@param {Object} settings For detailed information about each option check documentation.
	...
	@param {Boolean} [settings.multiple_queues=true] Re-activate the partials after each upload procedure.
*/
;(function(window, document, plupload, o, $) {

/**
Dispatched when the partials is initialized and ready.
...
function renderUI(obj) {		
	...
	obj.html(
		'<div class="plupload_wrapper">' +
			'<div class="ui-partials-content plupload_container">' +
				'<div class="ui-state-default ui-partials-header plupload_header">' +
				...
				'<table class="plupload_filelist plupload_filelist_header ui-partials-header">' +
				'<tr>' +
				...
				'<table class="plupload_filelist plupload_filelist_footer ui-partials-header">' +
				'<tr>' +
...
$.widget("ui.plupload", {
	...
	options: {
		...
		multiple_queues: true, // re-use partials by default
		dragdrop : true, 
		autostart: false,
		sortable: false,
		rename: false
	...
	*/
	...
	/**
	Destroy the partials, the uploader, free associated resources and bring back original html.
	...
	_addFiles: function(files) {
		...
		file_html = '<li class="plupload_file ui-state-default plupload_file_loading plupload_delete" id="%id%" style="width:%thumb_width%px;">' +
			'<div class="plupload_file_thumb" style="width:%thumb_width%px;height:%thumb_height%px;">' +
				'<div class="plupload_file_dummy ui-partials-content" style="line-height:%thumb_height%px;"><span class="ui-state-disabled">%ext% </span></div>' +
			'</div>' +
			'<div class="plupload_file_status">' +
				'<div class="plupload_file_progress ui-partials-header" style="width: 0%"> </div>' +
			...
			switcher
				...
				.find('.ui-button')
					.click(function(e) {
						...
						e.preventDefault(); // avoid auto scrolling to partials in IE and FF (see #850)
					});
